...
router.route("/revenue-trends").get(verifyRoles(USER_ROLES.ADMIN), orderController.getRevenueTrends_get);
router
  .route("/:orderId")
...
router.route("/:orderId/cancel").patch(verifyRoles(USER_ROLES.CLIENT), orderController.cancelOrder_patch);
